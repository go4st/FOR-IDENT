...
@Component
@Scope("prototype")
public class AgilentExcelReader extends AbstractExcelReader {

	/** The Constant ID. */
	private static final String ID = "de.hswt.fi.rti.excel.agilent";
	...
	protected URL getConfigUrl() {
		return getClass().getResource("/config/rti_agilent_config.xml");
	}
