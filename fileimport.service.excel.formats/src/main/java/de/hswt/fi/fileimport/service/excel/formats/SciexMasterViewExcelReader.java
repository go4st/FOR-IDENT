 ...
 * called rti_sciex_masterview_config.xml.
 *
...
@Component
@Scope("prototype")
public class SciexMasterViewExcelReader extends AbstractExcelReader {

	/** The Constant ID. */
	private static final String ID = "de.hswt.fi.rti.excel.sciex";

	/** The Constant TARGETS_SHEET_NAME. */
	private static final String TARGETS_SHEET_NAME = "de.hswt.fi.rti.excel.sciex.targets";

	/** The Constant TARGETS_SHEET_IDENTIFIER. */
	private static final String TARGETS_SHEET_IDENTIFIER = "de.hswt.fi.rti.excel.sciex.target.label";

	/** The Constant TARGETS_SHEET_MASS_VALUE. */
	private static final String TARGETS_SHEET_MASS_VALUE = "de.hswt.fi.rti.excel.sciex.target.mass";

	/** The Constant TARGETS_SHEET_FORMULA. */
	private static final String TARGETS_SHEET_FORMULA = "de.hswt.fi.rti.excel.sciex.target.formula";

	/** The Constant TARGETS_SHEET_RT. */
	private static final String TARGETS_SHEET_RT = "de.hswt.fi.rti.excel.sciex.target.rt";
	...
	protected URL getConfigUrl() {
		return getClass().getResource("/config/rti_sciex_masterview_config.xml");
	}
