...
/**
 * The Class RTIWatersMarkerLyncsMarkerExcelReader reads excel files with a
...
@Component
@Scope("prototype")
public class WatersMarkerLynxMarkerExcelReader extends AbstractExcelReader {

	/** The Constant ID. */
	private static final String ID = "de.hswt.fi.rti.excel.waters.markerlynx.marker";
	...
	protected URL getConfigUrl() {
		return getClass().getResource("/config/rti_waters_markerlynx_marker_config.xml");
	}
