...
/**
 * The Class RTIWatersUnifiExcelReader reads excel files with a defined content
...
@Component
@Scope("prototype")
public class WatersUnifiExcelReader extends AbstractExcelReader {

	/** The Constant ID. */
	private static final String ID = "de.hswt.fi.rti.excel.waters.unifi";
	...
	private static final String TARGETS_SHEET_FORMULA = "de.hswt.fi.rti.excel.waters.target.formula";
	...
	protected URL getConfigUrl() {
		return getClass().getResource("/config/rti_waters_unifi_config.xml");
	}
