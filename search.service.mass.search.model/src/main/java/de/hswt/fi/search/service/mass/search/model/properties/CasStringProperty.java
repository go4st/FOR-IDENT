...
/**
 * The Class CASStringProperty represents the CAS Number string property in the
 * DB.
 *
...
@Embeddable
@BeanComponent
public class CasStringProperty extends AbstractStringProperty {

	@Column(name = "cas_value", length = JpaPreferences.LENGTH_CAS)
	@BeanColumn(i18nId = I18nKeys.SI_MODEL_CAS)
	protected String value;

	@Column(name = "cas_source")
	@BeanColumn(i18nId = I18nKeys.SI_MODEL_SOURCE)
	protected String source;

	@Column(name = "cas_editor")
	protected String editor;

	@Column(name = "cas_additional", length = JpaPreferences.LENGTH_ADDITIONAL)
	@BeanColumn(i18nId = I18nKeys.SI_MODEL_ADDITIONAL)
	protected String additional;

	@Column(name = "cas_lastModified")
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof CasStringProperty)) return false;
		CasStringProperty that = (CasStringProperty) o;
