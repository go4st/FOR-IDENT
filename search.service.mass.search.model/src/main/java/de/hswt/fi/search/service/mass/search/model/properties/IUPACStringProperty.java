...
/**
 * The Class IUPACStringProperty represents the IUPAC string property in the DB.
 *
 * @author Marco Luthardt
 */
@Embeddable
@BeanComponent
public class IUPACStringProperty extends AbstractStringProperty {

	@Column(name = "iupac_value", length = JpaPreferences.LENGTH_IUPAC)
	@BeanColumn(i18nId = I18nKeys.SI_MODEL_IUPAC)
	protected String value;

	@Column(name = "iupac_source")
	@BeanColumn(i18nId = I18nKeys.SI_MODEL_SOURCE)
	protected String source;

	@Column(name = "iupac_editor", length = JpaPreferences.LENGTH_IUPAC)
	protected String editor;

	@Column(name = "iupac_additional", length = JpaPreferences.LENGTH_ADDITIONAL)
	@BeanColumn(i18nId = I18nKeys.SI_MODEL_ADDITIONAL)
	protected String additional;

	@Column(name = "iupac_lastModified")
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof IUPACStringProperty)) return false;
		IUPACStringProperty that = (IUPACStringProperty) o;
