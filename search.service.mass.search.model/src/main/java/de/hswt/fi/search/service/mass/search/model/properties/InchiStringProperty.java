...
@Embeddable
@BeanComponent
public class InchiStringProperty extends AbstractStringProperty {

	@Column(name = "inchi_value", length = JpaPreferences.LENGTH_INCHY)
	@BeanColumn(i18nId = I18nKeys.SI_MODEL_INCHI)
	protected String value;

	@Column(name = "inchi_source")
	@BeanColumn(i18nId = I18nKeys.SI_MODEL_SOURCE)
	protected String source;

	@Column(name = "inchi_editor", length = JpaPreferences.LENGTH_IUPAC)
	protected String editor;

	@Column(name = "inchi_additional", length = JpaPreferences.LENGTH_ADDITIONAL)
	@BeanColumn(i18nId = I18nKeys.SI_MODEL_ADDITIONAL)
	protected String additional;

	@Column(name = "inchi_lastModified")
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof InchiStringProperty)) return false;
		InchiStringProperty that = (InchiStringProperty) o;
