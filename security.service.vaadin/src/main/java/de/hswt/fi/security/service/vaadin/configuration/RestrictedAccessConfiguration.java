...
@Profile(value = {Profiles.PRODUCTION, Profiles.DEVELOPMENT})
@Configuration
@EnableWebSecurity
...
public class RestrictedAccessConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.logoutUrl(applicationProperties.getSecurity().getLogoutUrl())
		.logoutSuccessUrl(applicationProperties.getSecurity().getRedirectUrl())
		.permitAll();
