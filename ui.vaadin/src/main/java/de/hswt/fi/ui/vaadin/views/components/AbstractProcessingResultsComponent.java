...
public abstract class AbstractProcessingResultsComponent extends
    ...
    protected FilterGrid<ProcessCandidate> grid;
    protected HeaderRow groupingRow;
    private boolean frozenColumns;
    private Locale locale;
    private Label resultsLabel;

    public AbstractProcessingResultsComponent(EventBus.ViewEventBus eventBus, I18N i18n, ComponentFactory componentFactory,
    ...
    protected abstract void initRtiScreeningColumns();
