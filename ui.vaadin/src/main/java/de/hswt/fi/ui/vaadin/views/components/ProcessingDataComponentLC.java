...
@SpringComponent
@ViewScope
public class ProcessingDataComponentLC extends AbstractProcessingDataComponent {

	private static final long serialVersionUID = 1L;

	private static final Logger LOGGER = LoggerFactory.getLogger(ProcessingDataComponentLC.class);
	...
	@Autowired
	public ProcessingDataComponentLC(ViewEventBus eventBus, I18N i18n) {
	...
	private void initCalibrationDataGridColumns() {
		...
		calibrationDataGrid.addColumn(RTICalibrationData::getSignal)
				.setWidth(LayoutConstants.COLUMN_WIDTH_SMALL)
				.setCaption(i18n.get(UIMessageKeys.RTI_DATA_CALIBRATION_COLUMN_SIGNAL_LOGD))
