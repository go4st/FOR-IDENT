...
@SpringComponent
@ViewScope
public class SearchDetailsComponent extends AbstractDetailsComponent<Entry> {

	private static final long serialVersionUID = -5675170058819432496L;

	@Autowired
	public SearchDetailsComponent(I18N i18n, ApplicationProperties applicationProperties,
